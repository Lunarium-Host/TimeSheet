...
CREATE TABLE `company`  (
  ...
  `name` varchar(50) NULL DEFAULT '' COMMENT 'Имя',
  `about` text NULL DEFAULT NULL COMMENT 'Описание',
  `phone` varchar(12) NULL DEFAULT '' COMMENT 'Номер телефона',
  `email` varchar(100) NULL DEFAULT '' COMMENT 'e-mail',
...
CREATE TABLE `project`  (
  ...
  `code` varchar(50) NULL DEFAULT NULL COMMENT 'Код проекта',
  `name` varchar(50) NULL DEFAULT NULL COMMENT 'Наименование',
  `about` text NULL DEFAULT NULL COMMENT 'Описание',
...
CREATE TABLE `session`  (
  `id` varchar(32) NOT NULL COMMENT 'Идентификатор сессии',
  `idUser` int(11) NULL DEFAULT NULL COMMENT 'Идентификатор пользователя',
  `data` text NULL DEFAULT NULL COMMENT 'Данные сессии',
...
CREATE TABLE `task`  (
  ...
  `name` varchar(255) NULL DEFAULT NULL COMMENT 'Наименование',
  `about` varchar(255) NULL DEFAULT NULL COMMENT 'Описание',
...
CREATE TABLE `user`  (
  ...
  `name` varchar(45) NULL DEFAULT NULL COMMENT 'Имя пользователя',
  `surname` varchar(45) NULL DEFAULT NULL COMMENT 'Отчество пользователя',
  `lastname` varchar(45) NULL DEFAULT NULL COMMENT 'Фамилия пользователя',

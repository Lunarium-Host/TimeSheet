				...
				<DIV class="card-description col-12">
					<FORM id="userProfile" action="action/" method="POST">
						<div class="form-group">
							...
							<input id="name" name="name" placeholder="Имя" value="<?= $user['name'] ?>" type="text" class="form-control">
						</div>
						<div class="form-group">
							<label for="surname">Отчество:</label>
							<input id="surname" name="surname" placeholder="Отчество" value="<?= $user['surname'] ?>" type="text" class="form-control">
						</div>
						<div class="form-group">
							<label for="lastname">Фамилия:</label>
							<input id="lastname" name="lastname" placeholder="Фамилия" value="<?= $user['lastname'] ?>" type="text" class="form-control">
						</div>
						<div class="form-group">
